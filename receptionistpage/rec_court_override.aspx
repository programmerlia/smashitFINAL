...
.btn-primary:hover {
    ...
    <script type="text/javascript">
        function openEditModal(availabilityId, timeRange, courtName, modeName, takenBy, createdByStaffId) {
    ...
    var isLocked = String(createdByStaffId) === "1";
      document.getElementById('<%= btnConfirmApply.ClientID %>').disabled = isLocked;
      ddl.disabled = isLocked;
      ...
      document.getElementById('slotEditModal').classList.add('show');
        ...
        function confirmApplyMode() {
            var createdBy = document.getElementById('<%= hfCreatedByStaffID.ClientID %>').value;
            if (String(createdBy) === "1") {
                alert("This slot is locked and cannot be modified.");
                return false;
            }
